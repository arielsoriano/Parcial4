...
public class PreABMTurno extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new form PreABMTurno
     */
    
    static TurnoDTO turnosDTO = new TurnoDTO();
    ...
    private void initComponents() {
        ...
        jtTurnos.setModel(grillaCargos1);
    ...
    private void jbEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbEliminarActionPerformed
        if (jtTurnos.getSelectedRow() == -1){JOptionPane.showMessageDialog(null, "Seleccione turno");}
        else{
        turnos = turnosDTO.extraerTodo();
        turnosDTO.eliminar(turnos.get(jtTurnos.getSelectedRow()).getId());
        actualizarGrilla();}
    }//GEN-LAST:event_jbEliminarActionPerformed

    private void jbNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbNuevoActionPerformed
        AltaTurno jpAltaTurno = new AltaTurno();      
        JFrame jfAltaTurno = new JFrame();
        jfAltaTurno.add(jpAltaTurno, BorderLayout.CENTER);
        jfAltaTurno.pack();
        jfAltaTurno.setLocationRelativeTo(null);
        jfAltaTurno.setVisible(true);
    ...
    private void jbModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbModificarActionPerformed
        ...
        turnos = turnosDTO.extraerTodo();
        ModificarTurno jpModificarTurno = new ModificarTurno(turnos.get(jtTurnos.getSelectedRow()));  
        JFrame jfModificarTurno = new JFrame();
        jfModificarTurno.add(jpModificarTurno, BorderLayout.CENTER);
        jfModificarTurno.pack();
        jfModificarTurno.setLocationRelativeTo(null);
        jfModificarTurno.setVisible(true);}
    ...
    private void jbBuscarCodigoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbBuscarCodigoActionPerformed
        if ("".equals(jtfBuscarCodigo.getText())){
            ...
            turno = turnosDTO.extraer(Integer.valueOf(jtfBuscarCodigo.getText()));
            turnos.clear();
            turnos.add(turno);
            GrillaTurnos grilla = new GrillaTurnos(turnos);
            jtTurnos.setModel(grilla);
        }
    ...
    private static javax.swing.JTable jtTurnos;
