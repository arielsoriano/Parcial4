 ...
 * @author ariel
 */
public class ModificarCargo extends javax.swing.JPanel {
    ...
    public ModificarCargo(Cargo CARGO) {
        cargo = CARGO;    
        initComponents();
        jtfCodigo.setText(String.valueOf(cargo.getCodigo()));
        jtfDescripcion.setText(cargo.getDescripcion());
    }
    ...
    private void jbAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbAgregarActionPerformed
        ...
        else if ((Integer.parseInt(jtfCodigo.getText()) == 0)){JOptionPane.showMessageDialog(null, "Ingrese cargo correcto");}
        else{
            cargo.setCodigo(Integer.parseInt(jtfCodigo.getText()));
            cargo.setDescripcion(jtfDescripcion.getText());
            CargoDTO cargoDTO = new CargoDTO();
            cargoDTO.modificar(cargo);
            Window w = SwingUtilities.getWindowAncestor(this);
            w.setVisible(false);
            PreABMCargo.actualizarGrilla();}
