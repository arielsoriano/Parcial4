 ...
 * @author ariel
 */
public class AltaTurno extends javax.swing.JPanel {
    ...
    private void jbAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbAgregarActionPerformed
        ...
        else if (((jtfCodigo.getText().length() < 1))){JOptionPane.showMessageDialog(null, "Ingrese turno correcto");}
        else{
        Turno turno = new Turno();
        turno.setCodigo(Integer.parseInt(jtfCodigo.getText()));
        turno.setDescripcion(jtfDescripcion.getText());
        TurnoDTO turnoDTO = new TurnoDTO();
        turnoDTO.crear(turno);
        Window w = SwingUtilities.getWindowAncestor(this);
        w.setVisible(false);
